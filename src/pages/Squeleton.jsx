...
const Squeleton = () => {
  return (
    <div>
      <div
        role="status"
        className="max-full p-4 border border-transparent rounded shadow animate-pulse md:p-6"
      >
        ...
        <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-400 mb-2.5"></div>
        <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-400 mt-4"></div>
